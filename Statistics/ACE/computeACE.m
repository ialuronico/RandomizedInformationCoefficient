...
%
% Based on code available here: http://tinyurl.com/oja3k3v

function [psi] = computeACE(x,y)

% Example data ---------------------------------------------
% Demonstration of how ACE finds logarithmic transformations
% Results in blue; green is exp(phi)

ll=length(x); % number of data points
dim=1;  % number of terms on right hand side
